...
func startMigration(projectID string, recreateSchema, truncate bool, tableWorkers, segmentWorkers, batchSize int, offsetSegments, bulkCopy, accurateCounts, asyncPipeline bool, tables []string) (string, error) {
	req := map[string]any{
